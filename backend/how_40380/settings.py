"""
Django settings for how_40380 project.
...
WSGI_APPLICATION = 'how_40380.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "how_40380 API",
    "DESCRIPTION": "API documentation for how_40380 App",
    "VERSION": "v1",
}
