...
export class Blank extends React.Component {
  ...
  render = () => <ScrollView contentContainerStyle={{
    flexGrow: 1
      ...
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/2089730b-304e-4329-a6a7-6f4f844f9c76"
    }} style={styles.TouchableOpacity_2_1525} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_2201"))} />
      <TouchableOpacity source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/d2f95405-71e8-4b4f-bb01-69e24d5b67be"
    }} style={styles.TouchableOpacity_2_1526} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_1004"))} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/204d9b40-f4ad-4537-957a-732d5594c96c"
      ...
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/84490ccb-a8d6-4a7a-88b0-53e0d90668fb"
    }} style={styles.ImageBackground_2_1535} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5d987175-9344-47e9-a1ee-edd1a1539ef8"
      ...
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ed6f66dc-6e2e-4725-90c6-046424fe4dfd"
    }} style={styles.ImageBackground_2_1539} />
      <TouchableOpacity source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/1497025a-3eb2-45bd-89c3-af9127c49397"
    }} style={styles.TouchableOpacity_2_1540} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_1651"))} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/a372db5b-ff20-4eff-8016-7b37aca13518"
    }} style={styles.ImageBackground_2_1543} />
      <TouchableOpacity source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/0351f142-44ed-482b-8fde-3505714d358e"
    }} style={styles.TouchableOpacity_2_1544} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_1646"))} />
      ...
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3b017c56-381a-485d-973c-5da3059e0227"
    }} style={styles.ImageBackground_2_1547} />
      <View style={styles.View_2_1548} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/a82dafb7-a34c-48e3-8f7b-22b598d3c04c"
    }} style={styles.ImageBackground_2_1549} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/2d118adb-55a9-47da-b151-a0040bfa48c5"
    }} style={styles.ImageBackground_2_1550} />
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ed578356-0031-43c6-8e03-454b20ed91ca"
        ...
        <View style={styles.View_I2_1555_10_4}>
          <View style={styles.View_I2_1555_10_5}>
            <View style={styles.View_I2_1555_10_6}>
              <ImageBackground source={{
              uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/f6ea90d7-2f4e-46d5-859b-549cc6ae27e9"
            }} style={styles.ImageBackground_I2_1555_10_7} />
              <ImageBackground source={{
              uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/b531996c-560a-479b-b212-9996db27f65b"
          ...
          <ImageBackground source={{
          uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5b24b1b6-7bb3-4e82-8fd3-b00a474a85e4"
      ...
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/3af20b5a-4e0c-4846-98d0-2b3f509fcb6a"
    }} style={styles.ImageBackground_2_1557} />
      <TouchableOpacity source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/ff7195b5-6791-43ab-8220-fb128c84e3a4"
    }} style={styles.TouchableOpacity_2_1558} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_1583"))} />
      <TouchableOpacity style={styles.TouchableOpacity_2_1559} onPress={() => this.props.navigation.navigate(getNavigationScreen("2_1563"))} />
      <View style={styles.View_2_1560}>
        <Text style={styles.Text_2_1560}>Create Story</Text>
      </View>
      <ImageBackground source={{
      uri: "https://figma-alpha-api.s3.us-west-2.amazonaws.com/images/5b1506dc-e0ce-44cd-94dd-add015164261"
